...
int main(int argc, char* argv[]) {
  ...
  /* root sends m and n out to other processors */
  ...
  for (i=0; i<ie-is; i++)  A[i] = (double *) malloc(n * sizeof(double));

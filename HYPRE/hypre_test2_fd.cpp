...
int main(int argc, char *argv[]) {
  ...
  int Nx, Ny, Px, Py, PCGmaxit, PFMGmaxit, relch, rlxtype, npre, npost;
  ...
  HYPRE_StructPCGSetMaxIter(solver, PCGmaxit);
  HYPRE_StructPCGSetRelChange(solver, relch);
  ...
  HYPRE_StructPCGSetPrecond(solver,
			    ...
			    precond);
  HYPRE_StructPCGSetup(solver, A, bvec, xvec);
  ...
  HYPRE_StructPCGSolve(solver, A, bvec, xvec);
